...
naver_music_url = "https://music.naver.com/listen/history/index.nhn?type=TOTAL_V2&year=2019&month=09&week=2"
...
file_name = './20190928/NaverMusicTop100.txt'
...
for page in range(2):
    ...
    for k in range(len(nave_music_titles)):
